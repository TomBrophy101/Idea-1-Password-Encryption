...
There are three ways to enter into the main menu of the program, the first is via Face ID, the second is via Passcode and the thrid option is via an SMS code that will be sent to your phone number.
